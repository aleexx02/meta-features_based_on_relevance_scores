...
#   real classification target ReMF and Komorniczak operate on when
...
#   this), ReMF's accuracy-based relevance mechanism and Komorniczak's
...
#   ReMF/Komorniczak doing the same kind of task they do everywhere
