...
# ---------------------------------------------------------
# CONSISTENCY CHECK
# Verify that concept_distance_summary_exp1.csv matches
# the detailed pairwise values in concept_distances_exp1.csv
# ---------------------------------------------------------
import pandas as pd
dist_path = os.path.join(RESULTS_DIR, 'concept_distances_exp1.csv')
summ_path = os.path.join(RESULTS_DIR, 'concept_distance_summary_exp1.csv')
