...
#     heatmap_comparison_komorniczak_ABFS_cv_chunk{cs}_ninf{ni}_{drift}.png
#       CV protocol — classifiers: GNB, KNN, SVM, DT, MLP
#     heatmap_comparison_komorniczak_ABFS_preq_chunk{cs}_ninf{ni}_{drift}.png
#       Prequential protocol — classifiers: GNB, KNN, PAC, HT, MLP
#     Total: 16 configs x 2 drift types x 2 protocols = 64 figures
# ==============================================================================
