...
for drift_idx, drift_type, n_concepts in DRIFT_TYPES:
    ...
    for ax, matrix, title in [
        ...
        (axes[1], rc_matrix_ba_plot, f'Replication check experiment 1b (no shuffle) - {drift_type} drift'),
        (axes[2], diff, f'Difference: Our protocol (1b) - E2 ({drift_type} drift)')
    ]:
    ...
    fig.suptitle(f'Replication check experiment 1b (no shuffle vs E2) - {drift_type} drift - Balanced Accuracy', fontsize=13)
    plt.tight_layout()
